...
switch (true) do {
	...
	case (_sv >= 10 && _sv < 20): {
		_units = [["Team", 2, 0],["Team_MG", 2, 0],["Team_AT", 1, 0],["Motorized", 1, 1]];
		_percentage_inf = 80;
		_groups_max = 3;
	};
	case (_sv >= 20 && _sv < 40): {
		_units = [["Squad", 1, 0],["Team_MG", 1, 0],["Team", 2, 0],["Team_AT", 2, 0],["Team_AA", 1, 0],["Team_Sniper", 1, 0],["Motorized", 1, 1],["Mechanized_Heavy", 1, 1]];
		_percentage_inf = 80;
		_groups_max = 3;
		
	};
	case (_sv >= 40 && _sv < 60): {
		_units = [["Squad", 1, 0],["Team_MG", 1, 0],["Team", 1, 0],["Team_AT", 2, 0],["Squad_Advanced", 2, 0],["Motorized", 1, 1],["AA_Light", 1, 1],["Mechanized_Heavy", 2, 1]];
		_percentage_inf = 75;
		_groups_max = 4;
		
	};
	case (_sv >= 60 && _sv < 80): {
		_units = [["Squad", 1, 0],["Team_MG", 1, 0],["Team", 1, 0],["Team_AA", 2, 0],["Team_HAT", 2, 0],["Team_Sniper", 1, 0],["Motorized", 1, 1],["Mechanized_Heavy", 1, 1]];
		_percentage_inf = 70;
		_groups_max = 4;
		
	};
	case (_sv >= 80 && _sv < 100): {
		_units = [["Squad", 1, 0],["Team_MG", 1, 0],["Team", 1, 0],["Team_HAT", 2, 0],["Squad_Advanced", 3, 0],["Mechanized", 2, 1],["Armored_Light", 1, 1]];
		_percentage_inf = 65;
		_groups_max = 4;
		
	};
	case (_sv >= 100 && _sv < 120): {
		_units = [["Squad", 1, 0],["Team_MG", 1, 0],["Team", 1, 0],["Team_AA", 1, 0],["Team_HAT", 2, 0],["Squad_Advanced", 2, 0],["Team_Sniper", 1, 0],["Mechanized_Heavy", 1,1],["Armored_Light", 2, 1]];
		_percentage_inf = 60;
		_groups_max = 4;
	};
	case (_sv >= 120): {
		_units = [["Squad", 1, 0],["Team_MG", 1, 0],["Team", 1, 0],["Team_AA", 1, 0],["Team_HAT", 2, 0],["Squad_Advanced", 2, 0],["Team_Sniper", 1, 0],["Mechanized_Heavy", 1, 1],["Armored_Heavy", 2, 1]];
		_percentage_inf = 55;
		_groups_max = 4;
	};
};
