...
["INITIALIZATION",Format ["server_town_ai.sqf : Initialized for [%1].", _town getVariable "name"]] Call WFBE_CO_FNC_LogContent;
...
while {!WFBE_GameOver} do {
	...
	if(_sideID != WFBE_C_UNKNOWN_ID && !WFBE_GameOver) then {
		_side_enabled = false;
