...
["INITIALIZATION",Format ["server_town.sqf : Initialized for [%1].", _location getVariable "name"]] Call WFBE_CO_FNC_LogContent;
...
_maxSupplyValue = _location getVariable "maxSupplyValue";
		...
		while {!WFBE_GameOver} do {
				...
				if(_town_supply_time && !WFBE_GameOver && _sideID != WFBE_C_UNKNOWN_ID && !_skipTimeSupply) then
				{
