...
missionNamespace setVariable [Format["WFBE_%1PARAVEHICARGO", _side], 'GAZ_Vodnik_MedEvac'];//--- Supply Paradropping, Dropped Vehicle.
...
missionNamespace setVariable [Format["WFBE_%1_DefaultGearEngineer", _side], [
	['AK_74','ItemCompass','ItemMap','ItemWatch','ItemRadio','Binocular','NVGoggles'],
...
missionNamespace setVariable [Format["WFBE_%1_DefaultGearOfficer", _side], [
	['AK_74', 'RPG18', 'ItemCompass','ItemMap','ItemWatch','ItemRadio','Binocular','NVGoggles'],
