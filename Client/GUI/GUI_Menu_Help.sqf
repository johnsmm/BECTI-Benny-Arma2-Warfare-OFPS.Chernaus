...
switch (_action) do {
	case "onLoad": {
		{((findDisplay 508000) displayCtrl 160001) lbAdd _x} forEach ["Introduction", "Respawn", "Towns", "Base Structures and Functions", "About the Mission"];
...
//--------------------WarFare Info
"<br />
<t size='1.2' color='#2394ef' align='center'>Warfare WASP-AWESOME EDITION | v47 | - CO - Chernarus</t><br />
<t align='center'>
<br />
<br />
<br />
...
<br/>
<br/>
-The Chernarus is currently at version 47
<br/>
<br/>
